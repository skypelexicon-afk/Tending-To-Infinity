...
const CourseBoughtPopup: React.FC = () => {
    ...
    useEffect(() => {
        ...
        const showPopupLoop = () => {
            ...
            // hide popup after 5s
            hideTimeoutId = setTimeout(() => setVisible(false), 5000);
        ...
        <AnimatePresence>
            {visible && (
                <motion.div
                    ...
                    className="fixed bottom-5 left-5 z-50 max-w-xs px-4 py-3 rounded-xl shadow-lg flex items-start justify-center gap-3 border backdrop-blur-md bg-white/90 border-gray-200/40"
                >
